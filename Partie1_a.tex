...
N'ayant pas réussi à trouver de calibrage satisfaisant du modèle, l'exercice n'a pas pu aller jusqu'à proproser une épuration ou une modification structurelle du modèle, et seule une connaissance relative des défaut du modèle a pu être extraite de la comparaison des modèles entre eux.
