...
\begin{enumerate}[label=(\alph*),labelindent=\parindent,leftmargin=*]
       ...
       \item Un premier scenario illustre de façon simplifié la logique d'héritage permettant la création d'un nouveau composant D1 à partir des composants A, B1 et C1. On apelle mixin cette abstration informatique qui permet de composer différents trait en Scala.
