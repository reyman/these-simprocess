...
En ce qui concerne la seconde question questionnant les usages HPC de la discipline vis à vis de leur absence sur ce terrain, il faut bien noter que cet état de fait n'a pas toujours été vrai. Se posera alors ensuite la question ouverte suivante, que s'est il donc passé pour que l'on constate aujourd'hui une telle absence des géographes sur ce terrain ?
...
La plupart des auteurs abordant ce débat semble d'accord, l'apprentissage de la programmation que cela soit pour la modélisation chez les géographes \autocite[64]{Banos2013}, dans le cadre des humanités numériques \Anote{code_humanite}, ou encore dans les récits des géographes modélisateurs (Lena, Denise), l'apprentissage de la programmation n'est pas une fin en soit, elle est un moyen pour une fin. Elle est ce socle de connaissance initial, dont le contenu reste encore à définir, qui permet d'engager la co-construction entre les disciplines.


Les enjeux semblent important, et le débat passionant. Presque 10 années plus tard, qu'en est il de cet état de la question pour les SIG ? Qu'en est il de ces   craintes repris par Joliveau de la bouche de géographes (p481-482 Joliveau2004) ?
