...
\begin{figure}[htbp]
\begin{sidecaption}[fortoc]{ \hl{Schema ecqtg à commenter}}[fig:S_buildmeca1]
  \centering
 \includegraphics[width=1.0\linewidth]{a1a2mechanism.pdf}
  \end{sidecaption}
\end{figure}

\begin{figure}[htbp]
\begin{sidecaption}[fortoc]{ \hl{Schema ecqtg à commenter}}[fig:S_buildmeca2]
  \centering
