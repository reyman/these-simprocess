...
\makeatletter
\newtcbox{\keyword}{on line,boxrule=0.5pt,arc=2pt,coltext=mycolor,colback=light-gray,colframe=lgray,boxsep=0pt,left=3pt,right=3pt,top=2pt,bottom=2pt, before upper={\rule[-3pt]{0pt}{10pt}}}
\newtcbox{\keywordmin}{on line,fontupper=\scriptsize, boxrule=0.5pt,arc=2pt,coltext=mycolor,colback=light-gray,colframe=lgray,boxsep=0pt,left=2pt,right=2pt,top=1pt,bottom=1pt, before upper={\rule[-3pt]{0pt}{5pt}}}
\makeatother
